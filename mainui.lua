-- // Clear
local Repository												= "https://realbilly.lol/f0ndra/stuff/uistuff/"

local Library 													= loadstring(d7m.Functions.SecureGet(Repository .. "Library.lua"))()
local ThemeManager 												= loadstring(d7m.Functions.SecureGet(Repository .. "Addons/ThemeManager.lua"))()
local SaveManager 												= loadstring(d7m.Functions.SecureGet(Repository .. "Addons/SaveManager.lua"))()

do
    d7m.Data.FOV                                             = Drawing.new("Circle")
    d7m.Data.FOV.Radius                                      = 30
    d7m.Data.FOV.Visible                                     = false
    d7m.Data.FOV.Thickness                                   = 2
end
...
local Visual 													= Window:AddTab("Visual") do
    ...
    local World 												= Visual:AddLeftGroupbox("World") do
        ...
        World:AddButton({
            ...
            DoubleClick         = false,
            Func                = function()
                Options.SelectedSkyBox:SetValues(d7m.Functions.GetSkyBoxes())
...
local Misc = Window:AddTab("Misc") do 
    local Player 											    = Misc:AddLeftGroupbox("Player") do        
        ...
        Player:AddToggle("HiddenHead", {
            Text                = "Hidden Head",
            Default             = false
        }):AddKeyPicker("HiddenHeadKey", {
            Default 			= "Esc",
            SyncToggleState 	= true,
            Mode 				= "Toggle",
        ...
        Player:AddToggle("InvertAim", {
            Text                = "Invert Aim",
            Default             = false
        }):AddKeyPicker("InvertAimKey", {
            Default 			= "Esc",
            SyncToggleState 	= true,
            Mode 				= "Toggle",
        ...
        Player:AddToggle("InvertLimb", {
            Text                = "Invert Limb",
            Default             = false
        }):AddKeyPicker("InvertLimbKey", {
            Default 			= "Esc",
            SyncToggleState 	= true,
            Mode 				= "Toggle",
        ...
        Player:AddDropdown("AntiAimMethod", {
    ...
    local TabBox  											    = Misc:AddRightTabbox() do
        ...
        local Break = TabBox:AddTab("Break") do
            ...
            Break:AddButton({
                ...
                DoubleClick     = false,
                Func            = function()
                    d7m.Cooldowns.BreakSafes                 = false
                    d7m.Cooldowns.BreakRegisters             = false
                    d7m.Cooldowns.BreakDoors                 = false
                end
            })
        end
    end
    ...
    local Misc 											        = Misc:AddRightGroupbox("Misc") do        
        ...
        Misc:AddButton({
            ...
            DoubleClick         = false,
            Func                = function()
                Options.SelectedHitMarker:SetValues(d7m.Functions.GetHitMarkers()) 
...
ThemeManager:SetFolder("d7m/Themes")
SaveManager:SetFolder("d7m/Games/Criminality")
...
Library:Notify(string.format("Loaded UI.lua in %.4f MS", tick() - d7m.Data.Start))
